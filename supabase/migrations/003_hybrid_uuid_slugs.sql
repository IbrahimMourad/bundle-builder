...
insert into public.steps (id, slug, step_order, title, icon, next_label) values
  ...
  ('a0000001-0001-4000-8000-000000000002', 'plan', 2, 'Choose your plan', 'shield', 'Next: Choose your sensors'),
  ('a0000001-0001-4000-8000-000000000003', 'sensors', 3, 'Choose your sensors', 'sensor', 'Next: Add extra protection'),
  ('a0000001-0001-4000-8000-000000000004', 'protection', 4, 'Add extra protection', 'grid', 'Next: Review your system');
